"""``weave_queue`` — list / inspect / peek / enqueue / archive per-source-type queues."""
    ...
    return [
        Tool(
            ...
            description=(
                ...
                "Queues live at vault/.weave/queues/<source_type>.jsonl."
            ),
            inputSchema={
                "type": "object",
                "properties": {
...
def handle(cfg: Config, args: dict):
    ...
    from thinkweave.acquisition.sources import all_specs, load_user_config
