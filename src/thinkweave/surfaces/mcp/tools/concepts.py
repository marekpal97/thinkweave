"""``weave_concepts`` — action-dispatched (list/tighten/merge/search/source_counts/drift)."""
...
def _handle_canonical_for(cfg: Config, args: dict):
    ...
    from thinkweave.synthesis.centrality import canonical_for
...
def _handle_tighten(cfg: Config, args: dict):
    ...
    lines.append("\nTo merge, call weave_concepts_merge with from_concept and to_concept.")
...
def _handle_drift(cfg: Config, args: dict):
    ...
    from thinkweave.synthesis.concepts import drift_report, format_drift_report
