...
def cmd_dream(args: argparse.Namespace) -> None:
    ...
    if action == "scan":
        ...
        print("Usage: weave dream {scan|apply|tasks|revert-coarsen}", file=sys.stderr)
        sys.exit(2)
...
def cmd_dream_tasks(args: argparse.Namespace) -> None:
    ...
    consults the scan).
    """
    from thinkweave.operations.dream import DreamCycleScan, scan
    from thinkweave.operations.dream_tasks import enabled_tasks
