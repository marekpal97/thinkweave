...
def _catalyst_map(catalysts: list[dict] | None) -> dict[str, tuple[str, str]]:
    ...
    """
    from thinkweave.synthesis.hub import ALLOWED_FLAGS, FLAG_NEW
...
def merge_theme_into(
    ...
    *,
    ...
    1. Fold the loser's catalyst log + essence into the survivor
       (:func:`thinkweave.synthesis.hub.fold_hub_logs` — interleave,
    ...
    try:
        ...
        try:
            ...
            # drift is repairable via `weave themes rebuild-registry`.
