...
2. weave_extract creates decisions with best-available info
3. weave_judge reconciles with git reality ANY TIME LATER
"""
...
def find_decisions(
    ...
    `derived_from`, so decisions written by `weave_extract` (which sets both)
