...
``weave import chatgpt``, ``weave enrich``, ``weave hubs link``, plus the
established ``weave import claude-code --enrich``. Each callsite used to
    ...
    *,
    ...
    Args:
        ...
        default_threshold_n: Above this size, prefer batch when a key
            ...
            ``weave import claude-code`` precedent).
