...
``thinkweave.synthesis.enrich`` module.

Wraps the LLM concept-tagging pass and the post-enrichment reindex /
wikilink-materialization step that the MCP ``weave_enrich`` tool needs to run
...
from thinkweave.synthesis.enrich import enrich as _enrich
