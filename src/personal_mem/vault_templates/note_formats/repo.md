<!--
  Note-format template for source_type: repo
  Brief skeleton the research-repo writer follows. Seeded into your vault at
  vault/config/note_formats/repo.md on `mem init` — edit that copy directly to
  reshape every repo brief (user-owned, survives upgrades). Sections guide the
