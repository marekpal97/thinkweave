...
# Re-exports: business logic now lives in `personal_mem.operations.extract`,
# but tests and the legacy server module import these helpers from here.
from personal_mem.operations.extract import (  # noqa: E402, F401
...
def handle_landing(cfg: Config, args: dict):
    ...
    from personal_mem.operations.landing import render_landing
...
def handle_enrich(cfg: Config, args: dict):
    ...
    from personal_mem.operations.enrich import run_enrich
