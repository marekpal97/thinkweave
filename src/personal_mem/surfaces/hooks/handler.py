...
def _handle_post(tool_name: str, hook_input: dict) -> None:
    ...
    # Claude Code's PostToolUse payload uses ``tool_response`` for newer
    # versions and ``tool_output`` for older ones — accept both so the
    # capture path doesn't silently drop returned IDs across upgrades.
