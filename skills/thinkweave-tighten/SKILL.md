...
# Codex projection for `/tighten`

Read the [canonical ThinkWeave command contract](../../commands/tighten.md) completely, then execute it. The linked file is the
