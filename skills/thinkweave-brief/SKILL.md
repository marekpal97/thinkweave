...
# Codex projection for `/brief`

Read the [shared Codex adapter](../../docs/CODEX-SKILL-PROJECTION.md)
and the [canonical ThinkWeave command contract](../../commands/brief.md) completely, then execute the canonical contract through
that adapter.
