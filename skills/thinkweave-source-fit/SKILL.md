...
# Codex projection for `/source-fit`

Read the [canonical ThinkWeave command contract](../../commands/source-fit.md) completely, then execute it. The linked file is the
