...
| `/discover` | research_discovery | * | discover | Producer rail. Runs registered strategies — internal-state (`concept_coverage`, `decision_review`) and external-trigger (`rss_poll`, `mail_poll`, `external_tool_runner`). |
